        ...
        <form action="{{ route('register.post') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full px-4 py-3.5 rounded-xl bg-slate-950 border border-slate-800 focus:border-slate-500 text-white font-medium text-sm transition duration-200"
                />
            </div>
