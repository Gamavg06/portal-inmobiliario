...
@section('content')
<div class="bg-gradient-to-r from-slate-900 via-[#131927] to-[#0b0f19] text-white py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-b border-slate-800">
